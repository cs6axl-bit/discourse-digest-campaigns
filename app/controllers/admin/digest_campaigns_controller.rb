...
module Admin
  class DigestCampaignsController < Admin::AdminController
    ...
    def send_test_digest!(campaign_key:, test_email:, topic_ids:, send_at: nil, campaign_id: nil, campaign_html: false,
                         custom_html_body: nil, preheader_line_1: nil, preheader_line_2: nil,
                         subject_line_1: nil, subject_line_2: nil, subject_line_3: nil)
      ...
      message =
        UserNotifications.digest(
          user,
          campaign_topic_ids: Array(topic_ids),
...

      {
        sent_to: test_email,
        user_id: user.id,
        chosen_topic_ids: Array(topic_ids),
        campaign_key: campaign_key.to_s,
        campaign_id: campaign_id,
        campaign_html: campaign_html
      }

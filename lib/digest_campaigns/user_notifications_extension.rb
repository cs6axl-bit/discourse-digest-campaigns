    ...
    def digest(user, opts = {})
      ...
      html =
        if has_custom_html
          logo_url = nil
          begin
            logo_url = SiteSetting.email_logo_url.to_s.strip
          rescue
            logo_url = nil
          end
          if logo_url.blank?
            begin
              logo_url = SiteSetting.logo_small_url.to_s.strip
            rescue
              logo_url = nil
            end
          end
          if logo_url.blank?
            begin
              logo_url = SiteSetting.logo_url.to_s.strip
            rescue
              logo_url = nil
            end
          end
          ...
          <<~HTML
            <div style="max-width: 600px; margin: 0 auto;">
              #{logo_url.present? ? "<div style=\"text-align:center; padding: 10px 0;\"><img src=\"#{ERB::Util.html_escape(logo_url)}\" alt=\"\" style=\"max-width: 220px; height: auto;\" /></div>" : ""}
